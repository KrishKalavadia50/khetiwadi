...
function Til() {
  ...
  const content = {
    gu: {
      ...
      SubTitle: "ગુજરાત-૧,૨,૩,૪,૫,૬, ૧૦, સર્ટિફાઇડ, ફાઉન્ડેશન, ટ્રૂથફુલ",
    ...
    hi: {
      ...
      SubTitle: "गुजरात-1,2,3,4,5,6, 10,सर्टिफाइड, फाउंडेशन, ट्रूथफुल",
    ...
    en: {
      ...
      SubTitle: "Gujarat-1,2,3,4,5,6, 10, Certified, Foundation, Truthful",
