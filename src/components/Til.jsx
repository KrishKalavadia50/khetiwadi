...
function Til() {
  ...
  const content = {
    gu: {
      ...
      SubTitle: "ગુજરાત-૧,૨,૩,૪,૫,૬,૭, ૧૦, સર્ટિફાઇડ, ફાઉન્ડેશન, ટ્રૂથફુલ",
      CompanyName: "ખેતિવાડી બીજ નિગમ",
      address:" સરનામું: બસ સ્ટેશન રોડ, જામજોધપુર, જિલ્લો: જામનગર (ગુજરાત) – ૩૬૦૫૩૦",
      email: "ઈમેલ: khetiwadi269@gmail.com",
    ...
    hi: {
      ...
      SubTitle: "गुजरात-1,2,3,4,5,6,7, 10,सर्टिफाइड, फाउंडेशन, ट्रूथफुल",
      CompanyName: "खेतीवाड़ी बीज निगम",
      address:" पता: बस स्टैंड रोड, जामजोधपुर, जिला: जामनगर (गुजरात) – 360530",
      email: "ईमेल: khetiwadi269@gmail.com",
    ...
    en: {
      ...
      SubTitle: "Gujarat-1,2,3,4,5,6,7, 10, Certified, Foundation, Truthful",
      CompanyName: "KHETIWADI BEEJ NIGAM",
      address:" ADDRESS: BUS STATION ROAD. JAMAJODHPUR, DIST. JAMNAGAR (GUJARAT) 360530",
      email: "Email: khetiwadi269@gmail.com",
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <div className="Crop">
          <h2 id="title" style={{color: "#06a44f", textAlign: "center"}}></h2>
        ...
        <div className="footer">
          <div className="Company">
            <h2 id="CompanyName">KHETIWADI BEEJ NIGAM</h2>
            <p id="address">
              ADDRESS: BUS STATION ROAD. JAMAJODHPUR, DIST. JAMNAGAR (GUJARAT) 360530
            </p>
            <p id="email">Email: khetiwadi269@gmail.com</p>
          </div>
          <h3 id="footerTitle"></h3>
          <a href="tel:+919265374101" id="call" className="call">
            Call
          </a>
