...
function Moog() {
  ...
  const content = {
    gu: {
      ...
      SubTitle:
        "ગુજરાત-4,5,6,7,8,10, સર્ટિફાઇડ, ફાઉન્ડેશન, ટ્રૂથફુલ",
      CompanyName: "ખેતિવાડી બીજ નિગમ",
      address:
        " સરનામું: બસ સ્ટેશન રોડ, જામજોધપુર, જિલ્લો: જામનગર (ગુજરાત) – ૩૬૦૫૩૦",
    ...
    hi: {
      ...
      SubTitle:
        "गुजरात -4,5,6,7,8,10,सर्टिफाइड, फाउंडेशन, ट्रूथफुल",
      CompanyName: "खेतीवाड़ी बीज निगम",
      address:
        " पता: बस स्टैंड रोड, जामजोधपुर, जिला: जामनगर (गुजरात) – 360530",
    ...
    en: {
      ...
      SubTitle:
        "Gujarat -4,5,6,7,8,10, Certified, Foundation, Truthful",
